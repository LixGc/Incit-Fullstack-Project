...
export const SearchButton = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    setLoading(true);
    dispatch(fetchUserDashboard(username)).then(() => {
      setTimeout(() => {
        setLoading(false);
      }, 1500);
    });
          ...
          <form onSubmit={handleSubmit} type="submit">
            <div className="xl:w-96">
              <div className="input-group flex items-stretch w-full mb-4">
                ...
                />
                <button
                  className="btn inline-block px-6 bg-blue-600 text-white font-medium text-xs leading-tight uppercase rounded shadow-md hover:bg-blue-700 hover:shadow-lg focus:bg-blue-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-blue-800 active:shadow-lg transition duration-150 ease-in-out"
                  type="submit"
                  id="button-addon2">
                  <svg
                    aria-hidden="true"
