        ...
        <div className="fixed inset-0 bg-black bg-opacity-25 backdrop-blur-sm flex justify-center items-center z-50">
          <div className="relative">
            ...
            <div className="w-[600px] h-[400px] overflow-y-auto flex flex-col bg-white p-4 rounded">
              <h3 className="w-full py-2 mb-5 text-xl font-semibold text-gray-900 dark:text-white">My Profile</h3>
              ...
              <div className="text-gray-900 dark:text-white">
                <p className="mb-2 text-center">
                  ...
                  {user.username}{" "}
                  <a onClick={() => setShowModal2(true)} className="font-semibold hover:underline text-blue-400">
                    &#9998;Edit
                  </a>
                </p>
                ...
                <p className="mb-2 text-center">
                  <a onClick={() => setShowModal(true)} className="font-semibold hover:underline text-blue-400">
                    Reset Password?
                  </a>
                </p>
              </div>
